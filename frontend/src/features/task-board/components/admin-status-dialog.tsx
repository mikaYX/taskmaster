                ...
                <div className="space-y-4 py-2">
                    ...
                    <div className="space-y-2">
                        ...
                        <Select value={status} onValueChange={(v) => setStatus(v as TaskStatusValue)}>
                            ...
                            <SelectContent>
                                <SelectItem value="RUNNING">{t('taskBoard.statusRunning')}</SelectItem>
                                <SelectItem value="SUCCESS">{t('taskBoard.statusSuccess')}</SelectItem>
                                <SelectItem value="FAILED">{t('taskBoard.statusFailed')}</SelectItem>
                                <SelectItem value="MISSING">{t('taskBoard.statusMissing')}</SelectItem>
                            </SelectContent>
                        </Select>
                    </div>
                    <div className="space-y-2">
