...
describe('Guest Restrictions (e2e)', () => {
  ...
  it('GUEST should not be able to call /tasks/archived', () => {
    return request(app.getHttpServer()).get('/tasks/archived').expect(403);
  });

  it('GUEST should not be able to call /tasks/count', () => {
    return request(app.getHttpServer()).get('/tasks/count').expect(403);
  });

  it('GUEST should be able to call /tasks/board', () => {
    return request(app.getHttpServer()).get('/tasks/board').expect(200);
  });
